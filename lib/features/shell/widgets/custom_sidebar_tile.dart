  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Stack(
        ...
        children: [
          // Always include the positioned painter, but animate its opacity based on selection
          AnimatedPositioned(
            curve: Curves.easeInOut,
            duration: const Duration(milliseconds: 400),
            top: -63.0, // Your fixed offset for centering over 3 tiles
            left: 0,
            right: 0,
            ...
            child: AnimatedOpacity(
              ...
              duration: const Duration(milliseconds: 400),
              curve: Curves.easeInOut, // Matches position for smooth feel
              child: CustomPaint(painter: SelectedTile(), size: Size.infinite),
            ),
          ),
