                  ...
                  Expanded(
                    child: Column(
                      children: [
                        ...
                        _buildSection('Registration Information', [
                          _buildInfoRow(
                            'Registration Date',
                            formData.registrationValidFrom != null
                                ? _formatTimestamp(
                                  formData.registrationValidFrom!,
                                )
                                : null,
                          ),
                          _buildInfoRow(
                          ...
                          _buildInfoRow(
                            'Valid Until',
                            formData.registrationValidUntil != null
                                ? _formatTimestamp(
                                  formData.registrationValidUntil!,
                                )
                                : null,
                          ),
                        ]),
