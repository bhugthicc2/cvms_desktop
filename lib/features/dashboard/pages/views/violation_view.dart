...
class ViolationView extends StatefulWidget {
  ...
  const ViolationView({super.key, required this.onBackPressed});

  @override
  State<ViolationView> createState() => _ViolationViewState();
}

class _ViolationViewState extends State<ViolationView> {
