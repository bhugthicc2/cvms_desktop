...
class VehicleByCollegeView extends StatefulWidget {
  final VoidCallback onBackPressed;
  const VehicleByCollegeView({super.key, required this.onBackPressed});

  @override
  State<VehicleByCollegeView> createState() => _VehicleByCollegeViewState();
}

class _VehicleByCollegeViewState extends State<VehicleByCollegeView> {
            ...
            Expanded(
              child: BlocBuilder<VehicleCubit, VehicleState>(
                builder: (context, state) {
                  ...
                  return VehicleTable(
                    additionalHeaderItem: _buildCollegeDropdown(),
                    hasImportBtn: false,
                    title: 'Vehicles by College',
        ...
        children: [
          ...
          Expanded(
            child: CustomDropdown(
              ...
              initialValue: 'All',
              onChanged: (value) {
                context.read<VehicleCubit>().filterByCollege(value);
              },
            ),
          ),
        ],
