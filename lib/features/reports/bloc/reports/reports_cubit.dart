...
class ReportsCubit extends Cubit<ReportsState> {
  ...
  Future<void> captureChartsAndShowPdfPreview({
    required Future<Uint8List?> Function() vehicleDistributionCapture,
    required Future<Uint8List?> Function() yearLevelBreakdownCapture,
    required Future<Uint8List?> Function() studentWithMostViolationsCapture,
    required Future<Uint8List?> Function() cityBreakdownCapture,
    required Future<Uint8List?> Function() vehicleLogsDistributionCapture,
    required Future<Uint8List?> Function()
    violationDistributionPerCollegeCapture,
    required Future<Uint8List?> Function() top5ViolationByTypeCapture,
    required Future<Uint8List?> Function() fleetLogsCapture,
  }) async {
    Uint8List? vehicleDistributionChartBytes;
    Uint8List? yearLevelBreakdownChartBytes;
    Uint8List? studentwithMostViolationChartBytes;
    ...
    try {
      vehicleDistributionChartBytes = await vehicleDistributionCapture();
    } catch (_) {
      vehicleDistributionChartBytes = null;
    }

    try {
      yearLevelBreakdownChartBytes = await yearLevelBreakdownCapture();
    } catch (_) {
    ...
    try {
      studentwithMostViolationChartBytes =
          await studentWithMostViolationsCapture();
    } catch (_) {
      studentwithMostViolationChartBytes = null;
    }

    try {
      cityBreakdownChartBytes = await cityBreakdownCapture();
    } catch (_) {
    ...
    try {
      vehicleLogsDistributionChartBytes =
          await vehicleLogsDistributionCapture();
    } catch (_) {
    ...
    try {
      violationDistributionPerCollegeChartBytes =
          await violationDistributionPerCollegeCapture();
    } catch (_) {
      violationDistributionPerCollegeChartBytes = null;
    }

    try {
      top5ViolationByTypeChartBytes = await top5ViolationByTypeCapture();
    } catch (_) {
      top5ViolationByTypeChartBytes = null;
    }

    try {
      fleetLogsChartBytes = await fleetLogsCapture();
    } catch (_) {
